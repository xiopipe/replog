---
description: Verify the current work against the /docs specs using the spec-guardian agent.
argument-hint: [optional file or area]
allowed-tools: Read, Grep, Glob, Task
---

Use the **spec-guardian** subagent to verify that the implemented work meets the `/docs` specs.
