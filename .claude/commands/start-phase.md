---
description: Start a Build Plan phase — summarize its steps and acceptance criteria and propose a plan.
...
Remember: `/docs` is the source of truth and the domain rules are in @CLAUDE.md. Don't advance a phase without meeting the acceptance criteria.
